...
// Facebook Strategy - chỉ khởi tạo nếu có cấu hình
if (process.env.FACEBOOK_APP_ID && process.env.FACEBOOK_APP_SECRET) {
    ...
    console.warn('Facebook OAuth không được cấu hình. Bỏ qua Facebook Strategy.');
}

// Google Strategy - chỉ khởi tạo nếu có cấu hình
if (process.env.GOOGLE_CLIENT_ID && process.env.GOOGLE_CLIENT_SECRET) {
    ...
    console.warn('Google OAuth không được cấu hình. Bỏ qua Google Strategy.');
}
